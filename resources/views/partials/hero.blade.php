        ...
        <div
            ...
            <div class="flex justify-center">
                <a href="{{route('listings.create')}}"
                    class="inline-flex text-white bg-teal-500 border-0 py-2 px-6 shadow-lg focus:outline-none hover:bg-teal-600 rounded text-lg ease-in-out duration-300">
                    Post Job
                </a>
                <button
                    class="ml-4 inline-flex text-gray-700 bg-gray-100 border-0 py-2 px-6 shadow-lg focus:outline-none hover:bg-gray-400 rounded text-lg ease-in-out duration-300">Contact
                    Us</button>
            </div>
        </div>
